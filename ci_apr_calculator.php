...
Version: 1.0.0
Author: APR Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for APR Calculator by www.calculator.io";

function display_calcio_ci_apr_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_apr_calculator', 'display_calcio_ci_apr_calculator' );